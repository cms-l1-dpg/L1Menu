...
# Override the L1RCT configuration parameters in the GlobalTag
if options.reEmulRCT :
    ...
    process.GlobalTag = GlobalTag(process.GlobalTag, '74X_dataRun2_Prompt_v1', recordOverrides)  # for data emulation
