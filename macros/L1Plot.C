...
// ===  FUNCTION  ============================================================
//         Name:  L1Plot::FillWriteRateHistogram
//  Description:  
// ===========================================================================
bool L1Plot::FillWriteRateHistogram()
{
  ...
  return true;
}       // -----  end of function L1Plot::FillWriteRateHistogram  -----

// ===  FUNCTION  ============================================================
//         Name:  L1Plot::RunPlot
//  Description:  
// ===========================================================================
bool L1Plot::RunPlot( StructL1Event *L1Event_, std::map<std::string, L1Seed> *mL1Seed_)
{
  L1Event  = L1Event_;
  mL1Seed = mL1Seed_;
  return true;
