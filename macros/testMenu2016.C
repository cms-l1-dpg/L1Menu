...
int main ( int argc, char *argv[] )
{
  ...
  desc.add_options()
    ...
    ("doPlotRate",    po::value<bool>(),                                      "save rate plot to output")
    ("doPlotEff",     po::value<bool>(),                                      "save efficiency plot to output")
    ("doPrintLS",     po::value<bool>(),                                      "print out rate per LS to file")
